...
/**
 * Created by SheepYang on 16/7/13 20:55
 * 332594623@qq.com
 */
public class SchoolAdapter extends AbsRecyclerViewAdapter {

    private List<Contentlist> datas = new ArrayList<>();

    Context mContext;

    public SchoolAdapter(RecyclerView recyclerView, List<Contentlist> datas, Context context) {
