...
public class ImmersiveUtil
{
    ...
    private static class ImmersiveUtil19
    {
        ...
        public static void enter(View decor)
        {
            ...
            com.sheepyang.gankgirl.utils.SystemUiVisibilityUtil.addFlags(decor, FLAG_IMMERSIVE);
        }

        public static void exit(View decor)
        {

            com.sheepyang.gankgirl.utils.SystemUiVisibilityUtil.clearFlags(decor, FLAG_IMMERSIVE);
        }
    }
}
