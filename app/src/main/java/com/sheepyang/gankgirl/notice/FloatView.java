package com.sheepyang.gankgirl.notice;
...
private int pointerId;
    ...
    public void translationX(float fromX,float toX,float formAlpha, final float toAlpha  ){
        ...
        animatorSet.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                if(toAlpha==0){
                    com.sheepyang.gankgirl.notice.HeadsUpManager.getInstant(getContext()).dismiss();
        ...
        mHandle= new Handler(){
            ...
            public void handleMessage(Message msg) {
                ...
                if(headsUp.isActivateStatusBar()) {
                    com.sheepyang.gankgirl.notice.HeadsUpManager.getInstant(getContext()).silencerNotify(headsUp);
                }
                com.sheepyang.gankgirl.notice.HeadsUpManager.getInstant(getContext()).animDismiss(headsUp);
            }
        };
    ...
    protected void cancel(){
        com.sheepyang.gankgirl.notice.HeadsUpManager.getInstant(getContext()).animDismiss();
        cutDown = -1;
